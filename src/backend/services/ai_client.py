...
class AiClient:
    ...
    def evaluate_habit(
        ...
        prompt = (
            ...
            f"Pay close attention to intensity, performance targets, and "
            f"quantitative details in the description. Two habits with the same "
            f"name can deserve very different scores depending on the specifics. "
            f"For example, running 5 km at a 4:00/km pace is significantly harder "
            f"than running 5 km at a 6:00/km pace; lifting heavier weights is "
            f"harder than lighter ones; studying 3 hours is harder than 30 minutes. "
            f"Always factor in duration, distance, speed, volume, and any other "
            f"measurable parameters when they are provided.\n\n"
    ...
    def evaluate_habit_xp(
        ...
        prompt = (
            ...
            f"Pay close attention to intensity, performance targets, and "
            f"quantitative details in the description. Higher intensity or more "
            f"demanding targets (faster pace, heavier weight, longer duration) "
            f"should yield more XP than easier variants of the same activity.\n\n"
            f"Consider the effort, impact, and consistency required.\n"
